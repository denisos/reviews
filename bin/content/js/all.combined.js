...
(function(){dust.register("home_index",body_0);function body_0(chk,ctx){return chk.write("<div id=\"reviewsList\">").section(ctx.get("reviews"),ctx,{"block":body_1},null).write("</div>");}function body_1(chk,ctx){return chk.write("<p>").reference(ctx.get("isbn"),ctx,"h").write(" </p><p>").reference(ctx.get("title"),ctx,"h").write(" </p>");}return body_0;})();
